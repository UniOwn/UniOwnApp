    ...
    return (
        <div className="MainSection">
            <div className="MainSection-Label">
                <Image src={location} alt="" sizes="100vw" className="MainSection-Label_icon-location" />
                <Image src={battery} alt="" sizes="100vw" className="MainSection-Label_icon-battery" />
